...
public class SchedulingService {
    ...
    public SchedulingService(SchedulingContext context) {
    ...
    @Async("schedulingTaskExecutor")
    public CompletableFuture<List<Consultation>> getPacilianConsultationsAsync(String pacilianId) {
        log.info("Asynchronously fetching consultations for pacilian: {}", pacilianId);
        List<Consultation> consultations = context.getPacilianConsultations(pacilianId);
        return CompletableFuture.completedFuture(consultations);
    }
    ...
    public CompletableFuture<Boolean> bookConsultationWithDateTimeAsync(String caregiverId, String pacilianId, 
        ...
        log.info("Asynchronously booking consultation for pacilian {} with caregiver {}: {} to {}", 
    ...
    public CompletableFuture<Boolean> acceptConsultationWithDateTimeAsync(String caregiverId, 
                                                        ...
                                                        LocalDateTime startTime, 
                                                        LocalDateTime endTime) {
        log.info("Asynchronously accepting consultation for pacilian {} with caregiver {}: {} to {}", 
                pacilianId, caregiverId, startTime, endTime);
    ...
    public CompletableFuture<Boolean> rejectConsultationWithDateTimeAsync(String caregiverId, 
                                                        ...
                                                        LocalDateTime startTime, 
                                                        LocalDateTime endTime) {
        log.info("Asynchronously rejecting consultation for pacilian {} with caregiver {}: {} to {}", 
                pacilianId, caregiverId, startTime, endTime);
        boolean result = context.updateConsultationStatusWithDateTime(
